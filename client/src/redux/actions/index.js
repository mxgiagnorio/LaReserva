...
export const createTournament = (payload) => {
  return async function (dispatch) {
    try {
      const info = await axios.post("/tournaments", payload);
...
export const modifyTournaments = (
  ...
  return async function (dispatch) {
    try {
      const info = await axios.put(`/tournaments/${id}`, {
        name,
        amountOfTeams,
        dateInit,
        dateFinish,
...
export const createPlayers = (payload) => {
  return async (dispatch) => {
    try {
      const info = await axios.post("/players", payload);
      return dispatch({
        type: CREATE_PLAYER,
        payload: info.data,
      });
...
export const createTeam = (payload) => {
  return async (dispatch) => {
    try {
      const info = await axios.post("/teams", payload);
      return dispatch({
        type: CREATE_TEAM,
        payload: info.data,
      });
...
export const getTournamentsAdmin = (payload) => {
  return async (dispatch) => {
    try {
      const info = await axios.get("/tournaments/panel");
      return dispatch({
...
export const tournamentDetails = (id) => {
  return async function (dispatch) {
    try {
      const info = await axios.get(`/tournaments/${id}`);
      return dispatch({
...
export const putFixture = (id, payload) => {
  return async (dispatch) => {
    try {
      ...
      const info = await axios.put(`/tournaments/${id}`, obj);
      dispatch({
        type: PUT_FIXTURE,
        payload: info.data,
      });
...
export const addPoint = (id) => {
  return async (dispatch) => {
    try {
      const info = await axios.put(`/teams/add/${id}`);
      dispatch({
        type: ADD_POINT,
        payload: info.data,
      });
...
export const quitPoint = (id) => {
  return async (dispatch) => {
    try {
      const info = await axios.put(`/teams/quit/${id}`);
      dispatch({
        type: QUIT_POINT,
        payload: info.data,
      });
...
export const addGoal = (id) => {
  return async (dispatch) => {
    try {
      const info = await axios.put(`/players/add/${id}`);
      dispatch({
        type: ADD_GOAL,
        payload: info.data,
      });
...
export const quitGoal = (id) => {
  return async (dispatch) => {
    try {
      const info = await axios.put(`/players/quit/${id}`);
      dispatch({
        type: QUIT_GOAL,
        payload: info.data,
      });
...
export const searchTournaments = (name) => {
  return async function (dispatch) {
    try {
      const info = await axios.get(`/tournaments?name=${name}`);
...
export const getAllUsers = (payload) => {
  return async (dispatch) => {
    try {
      const info = await axios.get("/users", payload);
      dispatch({
        type: GET_ALL_USERS,
        payload: info.data,
      });
...
export const createUser = (payload) => {
  return async (dispatch) => {
    try {
      const info = await axios.post("/users/post", payload);
      dispatch({
        type: CREATE_USER,
        payload: info.data,
      });
...
export const banUser = (id) => {
  return async (dispatch) => {
    try {
      const info = await axios.put(`/users/ban/${id}`);
      dispatch({
        type: BAN_USER,
        payload: info.data,
      });
...
export const toAdmin = (id) => {
  return async (dispatch) => {
    try {
      const info = await axios.put(`/users/admin/${id}`);
      dispatch({
        type: TO_ADMIN,
        payload: info.data,
      });
...
export const getUserDetails = (email) => {
  return async function (dispatch) {
    const info = await axios.get(`/users/${email}`);
    return dispatch({
...
export const deleteUser = (email) => {
  return async function (dispatch) {
    try {
      const info = await axios.delete(`/users/${email}`);
      return dispatch({
        type: DELETE_USER,
        payload: info.data,
      });
...
export function getNext5Tournaments() {
  return async (dispatch) => {
    try {
      const nextTournaments = await axios.get("/next?index=1&limit=5");
...
export function getNextTournament() {
  return async (dispatch) => {
    try {
      const nextTournament = await axios.get("/next?index=0&limit=1");
...
export function deleteTournament(id) {
  return async (dispatch) => {
    try {
      const info = await axios.put(`/tournaments/enabled/${id}`);
      dispatch({
...
export function getReviews() {
  return async function (dispatch) {
    try {
      const info = await axios.get(`/reviews`);
...
export function postReviews(payload) {
  return async function (dispatch) {
    try {
      const info = await axios.post(`/reviews`, payload);
      return dispatch({
        type: "POST_REVIEWS",
        payload: info.data,
      });
...
export function deleteReviews(id) {
  return async function (dispatch) {
    try {
      const info = await axios.delete(`/reviews/${id}`);
      return dispatch({
        type: "DELETE_REVIEWS",
        payload: info.data,
      });
...
export function getIdReview(id) {
  return async function (dispatch) {
    try {
      const info = await axios.get(`/reviews/${id}`);
      return dispatch({
        type: "GET_ID_REVIEW",
        payload: info.data,
      });
...
export function getEnabledReviews() {
  return async function (dispatch) {
    try {
      const info = await axios.get("/reviews/enabled");
      return dispatch({
...
export function getDisabledReviews() {
  return async function (dispatch) {
    try {
      const info = await axios.get("/reviews/disabled");
      return dispatch({
...
export function reportAllowReview(id) {
  return async function (dispatch) {
    try {
      const info = await axios.put(`/reviews/${id}`);
      return dispatch({
        type: REPORT_REVIEW,
        payload: info.data,
      });
